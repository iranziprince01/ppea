              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 sm:px-4 py-2 sm:py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-colors duration-200"
              ...
              <div className="space-y-3 sm:space-y-4">
                <div className="flex items-start space-x-3 sm:space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm sm:text-base">KG 17 Ave, Kigali, Rwanda</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3 sm:space-x-4">
                  ...
                  <div>
                    <h4 className="font-medium text-gray-900 text-sm sm:text-base">Phone</h4>
                    <p className="text-gray-600 text-sm sm:text-base">+250791676618 / +250788561313</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3 sm:space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm sm:text-base">probitypartnersea1@gmail.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3 sm:space-x-4">
                  ...
                  <div>
                    <h4 className="font-medium text-gray-900 text-sm sm:text-base">Working Hours</h4>
                    <p className="text-gray-600 text-sm sm:text-base">Mon - Fri: 8:00 AM - 6:00 PM</p>
                  </div>
                </div>
              </div>
            </div>
